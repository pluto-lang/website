---
title: Simplify Cloud and AI App Development
---
...
# 3. Write your application code in the `app/main.py` file.
...
# 3. Write your application code in the `src/index.ts` file.
