...
- [Pulumi](https://www.pulumi.com/docs/install/): Pluto uses Pulumi to interact with cloud platforms (AWS or Kubernetes) for deploying cloud resources. Please follow the Pulumi installation documentation.
...
![Kubernetes Test Results](../../../public/assets/getting-started/getting-started-local-deploy-k8s-out.png)
