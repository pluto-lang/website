...
This is a Python version of the example Pluto application in the [Quick Start](/documentation/getting-started.en.mdx) guide. You can grab the full code from [here](https://github.com/pluto-lang/pluto/tree/main/examples/quickstart-python/).
...
If you haven't set up your Pluto development environment yet, please refer to the local development in the [Quick Start](/documentation/getting-started.en.mdx) guide for configuration. Alternatively, you can try out Pluto's [online sandbox or container](/documentation/getting-started.en.mdx).
