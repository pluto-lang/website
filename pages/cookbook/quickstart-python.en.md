...
This is a Python version of the example Pluto application in the[Quick Start](https://github.com/pluto-lang/pluto/tree/main/examples/quickstart-python/../../docs/documentation/getting-started.en.md) guide. You can grab the full code from [here](./).
...
If you haven't set up your Pluto development environment yet, please refer to steps 0 and 1 in the[Quick Start](https://github.com/pluto-lang/pluto/tree/main/examples/quickstart-python/../../docs/documentation/getting-started.en.md) guide for configuration. Alternatively, you can try out Pluto's [online sandbox or container](../../docs/documentation/getting-started.en.md#alternative-usage-methods).
