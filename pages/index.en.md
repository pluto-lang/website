...
You can learn more about the workflow of Pluto [here](documentation/how-pluto-works.en.md).
...
You can learn more about the differences with other project [here](documentation/whats-different.en.md).
...
For detailed steps, please refer to the [Getting Started Guide](documentation/getting-started.en.md).
...
Pluto is currently in the PoC stage, and we welcome interested people to contribute. Whether it is suggestions or ideas about the problems Pluto aims to solve, the features it provides, or code implementation, you can participate in the community to build together. Check out the project [contribution guide](dev_guide/dev_guide.en.md).
